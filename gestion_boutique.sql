...
CREATE TABLE `categorie` (
  ...
  `description_categorie` varchar(100) DEFAULT NULL,
...
CREATE TABLE `lignevente` (
  ...
  `soustotal` varchar(100) NOT NULL,
...
LOCK TABLES `lignevente` WRITE;
/*!40000 ALTER TABLE `lignevente` DISABLE KEYS */;
/*!40000 ALTER TABLE `lignevente` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-08 20:37:27
